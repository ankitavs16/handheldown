...
export default function Onboarding() {
  ...
  return (
    <div className="relative px-5 pt-12 min-h-screen flex flex-col overflow-hidden">
      <div className="absolute inset-0 z-0 pointer-events-none" aria-hidden="true">
        <div className="absolute -top-20 -left-24 w-72 h-72 rounded-full bg-gradient-to-br from-sky-200 via-blue-200 to-purple-200/70 blur-3xl opacity-90" />
        <div className="absolute bottom-6 -right-28 w-80 h-80 rounded-full bg-gradient-to-tl from-purple-200 via-blue-100 to-sky-100 blur-3xl opacity-90" />
        <div className="absolute top-1/3 right-4 w-40 h-40 rounded-full bg-pink-100/70 blur-3xl" />
        <div className="absolute bottom-1/4 -left-16 w-48 h-48 rounded-full bg-indigo-100/70 blur-3xl" />
      </div>
